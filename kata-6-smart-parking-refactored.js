const whereCanIPark = function (spots, vehicle) {
  // functions to search for available spot based on vehicle size
  const findRegular = function() {
    ...
    return false; // return false if no spots found
  }
